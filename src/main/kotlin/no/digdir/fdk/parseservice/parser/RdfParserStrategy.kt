...
interface RdfParserStrategy<T> {
     ...
     * @param acceptableTypes A list of RDF types that is acceptable as primary topic for a fdkRecord
     */
    fun hasAcceptablePrimaryTopic(recordResource: Resource, acceptableTypes: List<Resource>): Boolean = try {
     ...
     * @param fdkURIPattern A pattern for fdkRecord URIs
     */
    fun isValidFDKRecord(recordResource: Resource, acceptableTypes: List<Resource>, fdkURIPattern: String): Boolean =
        when {
