...
import no.digdir.fdk.parserservice.utils.InformationModelMerger
...
class InformationModelHandler(
     ...
     */
    fun parseInformationModel(fdkId: String, graph: String): JsonNode {
        val model = ModelFactory.createDefaultModel()
        val informationModel: InformationModel = try {
            ...
            if (resourceIRI != null) {
                ...
                // Merge all successfully parsed information models using the information model merger
                InformationModelMerger.merge(parsedInformationModels)
            } else {
